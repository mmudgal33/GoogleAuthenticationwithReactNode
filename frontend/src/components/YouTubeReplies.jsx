...
const YouTubeComments = ({ videoId, isAuthenticated, onAuthRequired }) => {
  ...
  const handleAddComment = async () => {
    ...
    try {
      await youtubeApi.addComment(videoId, newComment);
      setNewComment('');
  ...
  const handleUpdateComment = async () => {
    ...
    try {
      ...
      await youtubeApi.updateComment(commentId, editText);
  ...
  const handleAddReply = async (parentCommentId) => {
    ...
    try {
      await youtubeApi.addReply(parentCommentId, replyText);
      setReplyingTo(null);
      setReplyText('');
  ...
  const handleUpdateReply = async (replyId, currentText) => {
    ...
    try {
      await youtubeApi.updateReply(replyId, newText);
  ...
  const handleDeleteReply = async (replyId) => {
    ...
    try {
      await youtubeApi.deleteReply(replyId);
